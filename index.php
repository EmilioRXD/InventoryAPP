...
if (!file_exists(RAIZ . "/config.php")) {
    if (isset($_SESSION["hora_de_inicio"]) and ((time() - $_SESSION["hora_de_inicio"]) / 60) <= MINUTOS_EXPIRACION_SESION) {
        ...
        $lista_blanca = array("pasar-inventario", "alta-de-inventarios", "caja", "clientes", "compras", "divisas", "inventarios", "ventas", "creditos", "reportes-inventarios", "reportes", "reportes-caja", "reportes-ventas", "reportes-creditos", "gastos", "ajustes", "reportes-gastos", "reportes-bajas-inventario", "usuarios", "productos-en-stock");
